 ...
 * Allows users to register by entering their email and receiving a verification code
 */
export default function SignUp() {
    ...
    /**
     * Handles the OTP sending process
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.container}>
                    ...
                    <Text style={styles.subtitle}>
                        Enter your email address to start the registration process. We'll send a verification code to your email.
                    </Text>
                    ...
                    <TouchableOpacity onPress={() => router.push(SIGNIN_ROUTE)} style={styles.signInButton} disabled={loading}>
